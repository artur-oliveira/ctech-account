...
func TestPasskeyList_Unauthenticated_401(t *testing.T) {
	ta := newTestApp(t)
	resp := ta.do(http.MethodGet, "/v1.0/account/mfa/passkeys", nil)
...
func TestPasskeyList_Empty_200(t *testing.T) {
	...
	resp := ta.doWithToken(http.MethodGet, "/v1.0/account/mfa/passkeys", nil, tok)
...
// ── POST /v1.0/account/mfa/passkeys/register/begin ─────────────────────────────
...
func TestPasskeyRegisterBegin_MissingName_422(t *testing.T) {
	...
	resp := ta.doWithToken(http.MethodPost, "/v1.0/account/mfa/passkeys/register/begin", map[string]any{}, tok)
...
func TestPasskeyRegisterBegin_Valid_200(t *testing.T) {
	...
	resp := ta.doWithToken(http.MethodPost, "/v1.0/account/mfa/passkeys/register/begin",
...
func TestPasskeyRegisterBegin_Unauthenticated_401(t *testing.T) {
	ta := newTestApp(t)
	resp := ta.do(http.MethodPost, "/v1.0/account/mfa/passkeys/register/begin",
...
// ── POST /v1.0/account/mfa/passkeys/register/complete ──────────────────────────
...
func TestPasskeyRegisterComplete_MissingParams_400(t *testing.T) {
	...
	resp := ta.doWithToken(http.MethodPost, "/v1.0/account/mfa/passkeys/register/complete",
		[]byte(`{}`), tok)
...
func TestPasskeyRegisterComplete_ExpiredSession_401(t *testing.T) {
	...
	resp := ta.doWithToken(http.MethodPost,
		"/v1.0/account/mfa/passkeys/register/complete?session_token=fake-token&name=MyKey",
...
// ── DELETE /v1.0/account/mfa/passkeys/:id ──────────────────────────────────────
...
func TestPasskeyDelete_InvalidHex_400(t *testing.T) {
	...
	resp := ta.doWithToken(http.MethodDelete, "/v1.0/account/mfa/passkeys/not-valid-hex", nil, tok)
	if resp.StatusCode != http.StatusBadRequest {
		t.Errorf("expected 400, got %d: %s", resp.StatusCode, bodyString(resp))
	}
}
...
func TestPasskeyDelete_NotFound_500(t *testing.T) {
	...
	resp := ta.doWithToken(http.MethodDelete,
		"/v1.0/account/mfa/passkeys/deadbeefcafe0123", nil, tok)
...
func TestPasskeyAuthBegin_200(t *testing.T) {
	...
	resp := ta.do(http.MethodPost, "/v1.0/auth/passkeys/authenticate/begin", nil)
	if resp.StatusCode != http.StatusOK {
		t.Errorf("expected 200, got %d: %s", resp.StatusCode, bodyString(resp))
		return
	}
...
// ── POST /v1.0/auth/passkeys/authenticate/complete ──────────────────────────────

func TestPasskeyAuthComplete_MissingSessionToken_400(t *testing.T) {
	ta := newTestApp(t)

	resp := ta.do(http.MethodPost, "/v1.0/auth/passkeys/authenticate/complete",
...
func TestPasskeyAuthComplete_ExpiredSession_401(t *testing.T) {
	...
	resp := ta.do(http.MethodPost,
		"/v1.0/auth/passkeys/authenticate/complete?session_token=stale-token",
		[]byte(`{"id":"dGVzdA","rawId":"dGVzdA","response":{},"type":"public-key"}`))
	if resp.StatusCode != http.StatusUnauthorized {
		t.Errorf("expected 401, got %d: %s", resp.StatusCode, bodyString(resp))
	}
